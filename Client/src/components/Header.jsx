                ...
                {showResults && searchResults.length > 0 && (
                  <div className="absolute z-50 w-full mt-1 bg-white rounded-lg shadow-lg border border-gray-200">
                    {searchResults.map(plant => (
                      ...
                      >
                        <img src={plant.image} alt={plant.name} className="w-10 h-10 object-cover rounded" />
                        <div>
                          <p className="font-medium" style={{ color: theme.colors.primary }}>{plant.name}</p>
                          <p className="text-xs text-gray-500">${plant.price || 'View details'}</p>
                        </div>
                      </div>
                    ))}
                  </div>
